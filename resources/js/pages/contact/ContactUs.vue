        ...
        <div>
            ...
            <div class="w-full h-fit px-4 bg-cover bg-center relative"
                ...
                <div class="w-full h-fit py-12 flex items-center justify-center flex-col">
                    ...
                    <div
                        class="w-full h-fit py-4 px-4 lg:px-12 mt-4 flex flex-col lg:flex-row items-center justify-center gap-6">
                        ...
                        <div class="w-full h-fit">
                            <form @submit.prevent="submitForm" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-[#1C2852] text-[20px] font-medium">Mobile Number</label>
                                        <div
                                            ...
                                            <input v-model="form.mobile" type="text" class="w-full p-2 border-black text-black"
