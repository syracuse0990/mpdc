...
<<<<<<< HEAD
    ...
    :style="{ backgroundImage: `url(${fpbbg})`, backgroundSize: 'cover', backgroundPosition: 'center' }">
        <div class="flex flex-col min-[1025px]:flex-row items-center justify-center min-h-screen px-0 lg:px-6 py-8 gap-0 lg:gap-4">
...
=======
    ...
    :style="{ backgroundImage: `url(${fpbbg})`, backgroundSize: 'cover', backgroundPosition: 'center' }">
        <div class="flex flex-col md:flex-row items-center justify-center min-h-screen px-0 lg:px-6 py-8 gap-0 lg:gap-12">
...
<<<<<<< HEAD
                        <img src="../../images/primagessss.jpg" alt="Studio Floor Plan"
                            class="shadow-2xl drop-shadow-lg w-[80%] sm:w-[70%] md:w-auto max-w-[250px] sm:max-w-[300px] md:max-w-none mt-0 sm:mt-8">
=======
...
>>>>>>> 45bc8954c5b95a95d1ab5a78f624a5d74aa6fd4a
                            <thead>
                                ...
                                <tr class="border border-[#967524] text-center h-10 md:h-12 lg:h-16">
                                    <th class="text-base md:text-lg lg:text-2xl border border-[#967524]"></th>
                                    <th class="text-base md:text-lg lg:text-2xl border border-[#967524]">Floor</th>
                                    <th class="text-base md:text-lg lg:text-2xl border border-[#967524]">Wall</th>
                                    <th class="text-base md:text-lg lg:text-2xl border border-[#967524]">Ceiling</th>
                                </tr>
                            </thead>
