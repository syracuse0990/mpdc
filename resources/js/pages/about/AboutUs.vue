    ...
    <AppLayout>
        <div class="flex flex-col min-h-screen bg-white">
            ...
            <main class="relative bg-white">
                <div
                    class="w-full h-fit xl:h-screen bg-cover bg-center relative flex flex-col justify-center px-12 md:px-16 lg:px-32 py-12 md:py-16 lg:py-32"
                ...
                >
                    ...
                    <div ref="heroText" class="relative z-10 w-full max-w-4xl opacity-0 translate-y-10 transition-all duration-1000 ease-out pt-24 lg:pt-0">
