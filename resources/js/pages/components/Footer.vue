<template>
  <footer class="bg-[#1a2a56] text-white pt-9 pb-12 relative">
    <div class="max-w-screen-lg mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
      ...
      <!-- Section 2: Site Map -->
      <div class="flex flex-col items-center">
        <h3 class="text-2xl font-semibold mb-4">Site Map</h3>
        <ul class="space-y-2">
      ...
      <div class="flex flex-col items-center">
        ...
        <p class="text-md">
          <a href="tel:+639175150123" class="text-white hover:underline">
            0917 – 515 – 0123
          </a>
        </p>
        <div class="flex justify-center space-x-6 mt-4">
          <a href="https://www.instagram.com/thecerisetower?igsh=MXgxc2c1NHk2MXg4bg==" class="text-white text-2xl transition-colors duration-300 hover:text-[#E4405F]">
            <i class="fab fa-instagram"></i>
          </a>
          <a href="https://www.facebook.com/cerisetower/" class="text-white text-2xl transition-colors duration-300 hover:text-[#1877F2]">
